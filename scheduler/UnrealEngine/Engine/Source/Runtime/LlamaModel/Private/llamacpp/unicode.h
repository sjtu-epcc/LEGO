...
const std::vector<std::pair<uint32_t, uint32_t>> digit_ranges = {
...
const std::vector<std::pair<uint32_t, uint32_t>> letter_ranges = {
...
const std::vector<std::pair<uint32_t, uint32_t>> whitespace_ranges = {
...
const std::vector<std::pair<uint32_t, uint32_t>> accent_mark_ranges = {
...
const std::vector<std::pair<uint32_t, uint32_t>> punctuation_ranges = {
...
const std::vector<std::pair<uint32_t, uint32_t>> symbol_ranges = {
...
const std::vector<std::pair<uint32_t, uint32_t>> control_ranges = {
...
uint32_t codepoint_from_utf8(const std::string & utf8, size_t & offset) {
...
std::vector<uint32_t> codepoints_from_utf8(const std::string & utf8) {
...
std::vector<uint16_t> codepoints_to_utf16(const std::vector<uint32_t> & cps) {
    std::vector<uint16_t> result;
    for (size_t i = 0; i < cps.size(); ++i) {
...
uint32_t codepoint_from_utf16(const std::vector<uint16_t> & utf16, size_t & offset) {
...
std::vector<uint32_t> codepoints_from_utf16(const std::vector<uint16_t> & utf16) {
    std::vector<uint32_t> result;
    size_t offset = 0;
...
std::unordered_map<uint32_t, int> codepoint_type_map() {
...
int codepoint_type(uint32_t cp) {
    std::unordered_map<uint32_t, int> codepoint_types = codepoint_type_map();
    return codepoint_types[cp];
}

int codepoint_type(const std::string & utf8) {
    if (utf8.length() == 0)
...
std::unordered_map<uint8_t, std::string> bytes_to_unicode_map_bpe() {
...
std::string bytes_to_unicode_bpe(uint8_t byte) {
    std::unordered_map<uint8_t, std::string> map = bytes_to_unicode_map_bpe();
    return map.at(byte);
}

std::unordered_map<std::string, uint8_t> unicode_to_bytes_map_bpe() {
...
uint8_t unicode_to_bytes_bpe(const std::string & utf8) {
